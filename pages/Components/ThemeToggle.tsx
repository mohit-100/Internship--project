...
const ThemeToggle = () => {
  ...
  return (
    <div className="relative w-16 flex items-center dark:bg-gray-900 bg-teal-500 cursor-pointer border border-sky-500 rounded-full p-1" onClick={() => { setDarkMode(!darkMode) }}>
